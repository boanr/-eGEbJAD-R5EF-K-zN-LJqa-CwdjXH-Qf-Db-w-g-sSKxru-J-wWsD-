...
WITH WPH_LIST AS (
	...
	WHEN TECH_ID NOT LIKE 'XinPPI%' AND STEP_NAME LIKE 'SP-CVD-Deposition' THEN 'TSV'
	WHEN STEP_NAME LIKE 'SP-CVD-TB-Deposition' THEN 'MGTB'
    END DEVICE_ID
	FROM CIMDM.DM_MOVE_BT WHERE (STEP_NAME LIKE 'SP-CVD-Deposition' OR STEP_NAME LIKE 'SP-CVD-TB-Deposition' OR LOT_TYPE='MD')  AND (EQP_ID='ASPCV301' OR EQP_ID='BSPCV001')
...
WPH_TABLE AS (
	...
	WHEN DEVICE_ID='TSV' THEN 4.4
	WHEN DEVICE_ID='MGTB' THEN 16.3
    WHEN DEVICE_ID='MD'  THEN 17.24
